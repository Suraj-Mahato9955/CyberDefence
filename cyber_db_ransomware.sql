...
--
-- Table structure for table `ransomware`
--

DROP TABLE IF EXISTS `ransomware`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ransomware` (
  `id` int NOT NULL,
  `files_affected` int DEFAULT NULL,
...
--
-- Dumping data for table `ransomware`
--
